...
(
    id serial NOT NULL,
    user_id serial NOT NULL,
    CONSTRAINT user_cart_pk PRIMARY KEY (id),
...
(
    ...
    review_comment character varying(250),
...
ALTER TABLE IF EXISTS public.variation_option
    ADD CONSTRAINT variation_fk FOREIGN KEY (variation_id)
    REFERENCES public.product_variation (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    NOT VALID;
...
ALTER TABLE IF EXISTS public.product_item
    ADD CONSTRAINT value_fk FOREIGN KEY (value_id)
...
ALTER TABLE IF EXISTS public.cart_item
    ADD CONSTRAINT product_item_fk FOREIGN KEY (item_id)
...
ALTER TABLE IF EXISTS public.order_item
    ADD CONSTRAINT product_item_fk FOREIGN KEY (product_item_id)
    REFERENCES public.product_item (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE NO ACTION
    NOT VALID;
